...
import kotlinx.android.synthetic.main.app_bar_twitter_feed.*

class TwitterFeed : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.twitter_feed, menu)
        return true
    }
